...
/**
 * Input command used to create a credit application. Kept minimal and validated so
 * controllers can bind JSON directly to this command and forward it to the use case.
 */
